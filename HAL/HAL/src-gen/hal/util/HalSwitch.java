...
public class HalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HalPackage.ACTUATOR: {
			...
			if (result == null)
				result = caseDeviceType(actuator);
			if (result == null)
		...
		case HalPackage.ACTIVITY_LOG_ENTRY: {
			ActivityLogEntry activityLogEntry = (ActivityLogEntry) theEObject;
			T result = caseActivityLogEntry(activityLogEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.SENSOR_ENTRY: {
			...
			if (result == null)
				result = caseActivityLogEntry(sensorEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.ACTUATOR_ENTRY: {
			ActuatorEntry actuatorEntry = (ActuatorEntry) theEObject;
			T result = caseActuatorEntry(actuatorEntry);
			if (result == null)
				result = caseActivityLogEntry(actuatorEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.AUTOMATION_RULE: {
			...
			if (result == null)
				result = caseNamedElement(automationRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.ATOMIC_RELATIONAL_TERM: {
			...
			if (result == null)
				result = caseBooleanExpression(atomicRelationalTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.COMPOUND_RELATIONAL_TERM: {
			...
			if (result == null)
				result = caseBooleanExpression(compoundRelationalTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.RULE_ENTRY: {
			RuleEntry ruleEntry = (RuleEntry) theEObject;
			T result = caseRuleEntry(ruleEntry);
			if (result == null)
				result = caseActivityLogEntry(ruleEntry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Activity Log Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Activity Log Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActivityLogEntry(ActivityLogEntry object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Actuator Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Actuator Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActuatorEntry(ActuatorEntry object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRuleEntry(RuleEntry object) {
		return null;
	}
