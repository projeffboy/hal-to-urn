 ...
 * <!-- end-user-doc -->
 * @see hal.HalPackage#getComparisonOperator()
 * @model
 * @generated
 */
public enum ComparisonOperator implements Enumerator {
	 ...
	 * @ordered
	 */
	GREATERTHANOREQUAL(2, "GREATERTHANOREQUAL", "GREATERTHANOREQUAL"),
	 ...
	 * @ordered
	 */
	LESSTHANOREQUAL(4, "LESSTHANOREQUAL", "LESSTHANOREQUAL"),
	 ...
	 * @generated
	 */
	private static final ComparisonOperator[] VALUES_ARRAY = new ComparisonOperator[] { EQUAL, GREATERTHAN,
			GREATERTHANOREQUAL, LESSTHAN, LESSTHANOREQUAL, NOTEQUAL, };
	...
	public static ComparisonOperator get(int value) {
		...
		case GREATERTHAN_VALUE:
			return GREATERTHAN;
		case GREATERTHANOREQUAL_VALUE:
			return GREATERTHANOREQUAL;
		case LESSTHAN_VALUE:
			return LESSTHAN;
		case LESSTHANOREQUAL_VALUE:
