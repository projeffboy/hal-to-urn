 ...
 * </p>
 * <ul>
 *   <li>{@link hal.impl.ActionImpl#getActuator <em>Actuator</em>}</li>
 *   <li>{@link hal.impl.ActionImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (actuator != null && actuator.eIsProxy()) {
			...
			if (actuator != oldActuator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HalPackage.ACTION__ACTUATOR, oldActuator,
							actuator));
			}
		}
		return actuator;
	...
	public Command getCommand() {
		if (command != null && command.eIsProxy()) {
			...
			if (command != oldCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HalPackage.ACTION__COMMAND, oldCommand,
							command));
			}
		}
		return command;
